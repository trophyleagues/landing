...
export const HeaderLang = new LocalizedStrings({
  en: {
    forum: "FORUM",
...
export const FormLang = new LocalizedStrings({
  en: {
    name: "FULLNAME",
    email: "EMAIL",
    country: "COUNTRY",
  ...
  es: {
    ...
    country: "PAÍS",
    password: "CONTRASEÑA",
    logIn: "Ya tengo una cuenta, ingresar",
    submit: "Pre registro",
    terms: "Acepto los términos generales de uso"
  },
  cat: {
    name: "NOM",
  ...
  pt: {
    ...
    country: "PAIS",
    password: "SENHA",
    logIn: "Eu já tenho uma conta, Conecte-se",
    submit: "Pré-registro",
    terms: "Aceito as condições gerais de uso"
    },
  it: {
    name: "NOME",
    email: "EMAIL",
    country: "PAESE",
    password: "PASSWORD",
    logIn: "Ho già e account, accesso",
    submit: "Pre-registrazione",
    terms: "Accetto le condizioni generali d'uso"
  }
})
